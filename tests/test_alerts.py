...
async def test_daily_scan_creates_in_app_alert(async_session):
    ...
    remote_job = Job(
        ...
        company="Remote Learning Co",
        title="Remote Python Tutor",
        location="Remote",
        remote_type="remote",
        salary_min=40000,
        salary_max=50000,
        description="Teach Python in a remote learning environment.",
    ...
    onsite_job = Job(
        ...
        salary_min=40000,
        salary_max=50000,
        description="Teach Python in person.",
    ...
    rss_job = Job(
        ...
        salary_min=60000,
        salary_max=70000,
        description="Remote role from RSS source teaching Python.",
...
async def test_alerts_api_lists_and_marks_read(async_session):
    ...
    try:
        ...
        job = Job(
            ...
            salary_min=50000,
            salary_max=60000,
            description="Remote technical training role.",
            application_url="https://example.com/apply",
            source_url="https://example.com/job",
            raw_payload={},
